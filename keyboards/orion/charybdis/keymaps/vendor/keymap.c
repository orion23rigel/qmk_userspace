...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_TIL_TO_0] = ACTION_TAP_DANCE_DOUBLE(LSFT(KC_GRAVE), TO(0)),
    [TD_F12_TO_0] = ACTION_TAP_DANCE_DOUBLE(KC_F12, TO(0)),
};
