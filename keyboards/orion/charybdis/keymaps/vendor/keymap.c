...
tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_ESC_TO_0] = ACTION_TAP_DANCE_DOUBLE(KC_ESC, TO(0)),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(TD_ESC_TO_0, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, 
    ...
    [1] = LAYOUT(TD_ESC_TO_0, KC_EXLM, KC_AT, KC_HASH, KC_DLR, KC_PERC, KC_CIRC, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_UNDS, KC_NUM, KC_LBRC, KC_P7, KC_P8, KC_P9, KC_RBRC, KC_PSCR, KC_NO, KC_UP, KC_NO, LALT(KC_F4), KC_TRNS, KC_PEQL, KC_PPLS, KC_P4, KC_P5, KC_P6, KC_PMNS, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, LALT(KC_LEFT), KC_TRNS, KC_PDOT, KC_PAST, KC_P1, KC_P2, KC_P3, KC_PSLS, KC_NO, KC_PGUP, KC_PGDN, LALT(KC_LEFT), LALT(KC_RGHT), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P0),
    [2] = LAYOUT(TD_ESC_TO_0, KC_F1, KC_F2, KC_F3, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_TRNS, KC_PSCR, KC_NO, KC_UP, KC_NO, LALT(KC_F4), KC_LBRC, KC_P7, KC_P8, KC_P9, KC_RBRC, KC_NUM, KC_TRNS, KC_NO, KC_LEFT, KC_DOWN, KC_RGHT, LALT(KC_LEFT), KC_PPLS, KC_P4, KC_P5, KC_P6, KC_PMNS, KC_PEQL, KC_TRNS, KC_NO, KC_PGUP, KC_PGDN, LALT(KC_LEFT), LALT(KC_RGHT), KC_PAST, KC_P1, KC_P2, KC_P3, KC_PSLS, KC_PDOT, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_P0),
    [3] = LAYOUT(TD_ESC_TO_0, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_DEL, KC_TRNS, DPI_RMOD, S_D_RMOD, LCTL(KC_F4), KC_TRNS, S_D_MOD, DPI_MOD, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, LALT(KC_LEFT), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, DRGSCRL, SNIPING, LALT(KC_LEFT), LALT(KC_RGHT), KC_TRNS, KC_TRNS, SNIPING, DRGSCRL, MS_BTN3, KC_TRNS, KC_TRNS, MS_BTN3, KC_TRNS, KC_TRNS, MS_BTN3, KC_TRNS, KC_TRNS, KC_TRNS)
};
// clang-format on
