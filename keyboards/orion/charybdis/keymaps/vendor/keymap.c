...
tap_dance_action_t tap_dance_actions[] = {
    [TD_ESC_TO_0] = ACTION_TAP_DANCE_DOUBLE(KC_ESC, KC_GRV),
};

// clang-format off
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(TD(TD_ESC_TO_0), KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_MINS, 
